...
public class TestBinarySearch {
    ...
    public void test1() {
        ...
        // 找到了
        assertEquals(0, binarySearchBasis(a, 7));
        assertEquals(1, binarySearchBasis(a, 13));
        assertEquals(2, binarySearchBasis(a, 21));
        assertEquals(3, binarySearchBasis(a, 30));
        assertEquals(4, binarySearchBasis(a, 38));
        assertEquals(5, binarySearchBasis(a, 44));
        assertEquals(6, binarySearchBasis(a, 52));
        assertEquals(7, binarySearchBasis(a, 53));

        // 没找到
        assertEquals(-1, binarySearchBasis(a, 0));
        assertEquals(-1, binarySearchBasis(a, 15));
        assertEquals(-1, binarySearchBasis(a, 60));
    }
